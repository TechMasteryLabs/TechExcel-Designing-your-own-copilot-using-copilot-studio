---
title: 'Exercise 09: Agent Flows and Triggers'
layout: default
nav_order: 11
has_children: true
---
...
# Exercise 09: Agent Flows and Triggers


## Goals for this lab

After this lab you will be able to:  
- Understand how to create automation by using Agent Flows
- Enable Autonomous Agents by using Triggers
