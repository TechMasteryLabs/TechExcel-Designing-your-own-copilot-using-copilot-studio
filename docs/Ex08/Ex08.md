---
title: 'Exercise 08: Model a Business Process with AI'
layout: default
nav_order: 10
has_children: true
---
...
# Exercise 08: Model a Business Process with AI


## Goals for this lab

After this lab you will be able to:  
- Understand how to build an Agent to assist with customer interactions
- Build an Agent that can access Dataverse records in a Power App
- Extend the Agent to create new Dataverse records in a Power App


## AI that can offer human-like support
